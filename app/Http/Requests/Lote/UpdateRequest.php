...
class UpdateRequest extends Request
{
    ...
    {
        return [
            'lote_id'               => 'required|unique:lote,lote_id,'
                                        .$this->request->get('lote_id').
                                        ',lote_id',
            ...
            'lote_fecha_documento'  => 'required|date_format:d-m-Y',
            'lote_fecha_planta'     => 'required|date_format:d-m-Y',
    ...
    public function messages()
    {
        return [
            ...
            'lote_destino_id.required' => 'Debes seleccionar una Destino',
