...
use App\Models\Pallet_PT;


class PalletPTController extends Controller
{
    ...
    public function print_etiqueta($id)
    {
        ...
        $data['lote_number'] = $lote->lote_id;
            ...
            $view =  \View::make('empaque.etiqueta_mp.invoice_es',
                compact('data'))->render();
    ...
    public function indexAll(Request $request)
    {
        ...
        {
            return view('empaque.etiqueta.index_all');
        }
    }
    ...
    public function index(Request $request)
    {
        ...
        {
            return view('empaque.pallet_pt.index');
        }
    }
    ...
    public function create()
    {
        ...
        return view('empaque.pallet_pt.create',compact('proximo_pallet'));
