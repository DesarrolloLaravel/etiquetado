...
Route::group(['prefix' => 'admin', 'middleware' => ['auth','profile:administracion'],'namespace' => 'Admin'], function(){
    ...
    Route::get('etiqueta/print_especial/{id}/{idioma}', 'NordicController@print_etiqueta');
...
Route::group(['prefix' => 'almacenamiento', 'middleware' => ['auth','profile:almacenamiento'], 'namespace' => 'Almacenamiento'], function(){
