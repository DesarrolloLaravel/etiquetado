...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        {   
            ...
            var printPage = window.open('{{ url("empaque/etiqueta_mp/print") }}'+'/'+etiqueta_id, '');
            alert(printPage);
        });
...
@include('empaque.orden_trabajo.modaladd')
@include('empaque.orden_trabajo.modaledit')
@include('empaque.orden_trabajo.modalreturn')
@include('empaque.orden_trabajo.modaldelete')
@include('empaque.orden_trabajo.modalreturnetiqueta')
@endsection