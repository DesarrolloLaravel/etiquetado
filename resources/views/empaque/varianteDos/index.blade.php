...
@include('empaque.varianteDos.modaladd')
@include('empaque.varianteDos.modaledit')
@include('empaque.varianteDos.modaldelete')
@include('empaque.varianteDos.modalerror')
