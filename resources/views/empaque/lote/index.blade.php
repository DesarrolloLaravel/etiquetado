        ...
        <div class="col-md-12">
            <div class="box box-primary">
                <div class="box-body">
                    ...
                    <a class="btn btn-primary" href="{{ url('/empaque/anulados') }}" id="anulados">
                        Anulados
                    </a>
                    <br><br>
...
@include('empaque.lote.produccion')
@include('empaque.lote.modaledit')
@include('empaque.lote.modaldelete')
