            ...
            $.get('etiqueta/reprint',
                ...
                function(data){
                    if(data[0] == "ok")
                    {
                        ...
                        var printPage = window.open('{{ url("empaque/etiqueta_mp/print") }}'+'/'+etiqueta__id+'/'+idioma, '');
                        printPage.print();
                    }
                    else
                    {
...
@include('empaque.etiqueta_mp.modalrecepcion')
@include('empaque.etiqueta_mp.modalcancel')
