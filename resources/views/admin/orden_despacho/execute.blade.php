        ...
        <div class="col-md-12">
            <div class="box box-primary">
                <div class="box-body">
                    ...
                    @include('admin.orden_despacho.execute_fields')
            ...
            <div class="box box-primary">
                <div class="box-body">
                    ...
                    @include('admin.orden_despacho.execute_table')
...
@include('admin.orden_despacho.modal_orden_despacho')
@include('admin.orden_despacho.modal_despacho')

@if(\Auth::user()->users_role == "administracion")
    @include('admin.orden_despacho.modal_despachar')
@endif
