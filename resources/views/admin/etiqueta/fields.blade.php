	...
	<div class="col-sm-4">
		<div class="form-group">
			{!! Form::label('orden', 'Orden',
				['class' => 'control-label']) !!}
			<div class="input-group">
				<input name="orden_id" id="orden_id" type="text" class="form-control" value="{{ $orden_id }}" disabled>
				<span class="input-group-btn">
	...
	<div class="col-sm-2">
		<div class="form-group">
			{!! Form::label('producto', 'Peso Estándar',
				['class' => 'control-label']) !!}
			{!! Form::text('peso_estandar', $peso_estandar, ['class' => 'disabled form-control', 'id' => 'peso_estandar', 'disabled']) !!}
		</div>
	</div>
	<div class="col-sm-3">
		<div class="form-group">
	...
	<div class="col-sm-4">
		<div class="form-group">
			{!! Form::label('caja_number', 'Número de Caja',
				['class' => 'control-label']) !!}
			{!! Form::text('caja_number', $caja_id, ['class' => 'disabled form-control', 'disabled']) !!}
		</div>
	</div>
	<div class="col-sm-1">
