<div class="col-sm-6">
	...
	<div class="col-sm-6">
		<div class="form-group">
			{!! Form::label('procesadora', 'Calidad',
				['class' => 'control-label']) !!}
			{!! Form::select('lote_calidad_id', 
							\Config::get('options.calidad'),
							null, 
							['class' => 'form-control']) !!}
		</div>
	</div>
	...
	<div class="col-sm-6">
		<div class="form-group">
			<div class="form-group">
				{!! Form::label('lote_condicion', 'Condición',
					['class' => 'control-label']) !!}
	...
	<div class="col-sm-6">
		<div class="form-group">
			{!! Form::label('tipo_mp', 'Tipo Materia Prima',
				['class' => 'control-label']) !!}
	...
	<div class="col-sm-6">
		<div class="form-group">
			{!! Form::label('variedad', 'Variedades',
				['class' => 'control-label']) !!}
			{!! Form::select('lote_variedad_id', 
							$variedades,
							null, 
							['class' => 'form-control']) !!}
		</div>
	...
	<div class="col-sm-4">
		<div class="form-group">
			{!! Form::label('fecha_ingreso', 'Fecha Guía/Factura',
				['class' => 'control-label']) !!}
			{!! Form::text('lote_fecha_documento', null, ['class' => 'form-control datepicker']) !!}
		</div>
	</div>
	<div class="col-sm-4">
		<div class="form-group">
			{!! Form::label('nombre', 'Fecha Ingreso Planta',
				['class' => 'control-label']) !!}
			{!! Form::text('lote_fecha_planta', null, ['class' => 'form-control datepicker']) !!}
		</div>
	</div>
	<div class="col-sm-4">
		<div class="form-group">
			{!! Form::label('fecha_expiracion', 'Fecha Vencimiento',
				['class' => 'control-label']) !!}
			{!! Form::text('lote_fecha_expiracion', null, ['class' => 'form-control datepicker']) !!}
		</div>
	</div>
	<!-- 2nd row -->
	...
	<div class="col-xs-8">
		<div class="form-group">
			{!! Form::label('kilos', 'Observaciones',
				['class' => 'control-label']) !!}
			{!! Form::textarea('lote_observaciones', null, ['rows' => 5]) !!}
		</div>
	</div>
</div>