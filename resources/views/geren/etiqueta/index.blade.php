            ...
            $.get('etiqueta/reprint',
                ...
                function(data){
                    if(data[0] == "ok")
                    {
                        ...
                        var printPage = window.open('{{ url("geren/etiqueta/print") }}'+'/'+etiqueta_id+'/'+idioma, '');
                        printPage.print();
                    }
                    else
                    {
...
@include('geren.etiqueta.modalrecepcion')
@include('geren.etiqueta.modalcancel')
@include('geren.etiqueta.modalidioma')
