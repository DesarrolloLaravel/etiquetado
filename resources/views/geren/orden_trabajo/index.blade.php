...
@include('geren.orden_trabajo.modaladd')
@include('geren.orden_trabajo.modaledit')
@include('geren.orden_trabajo.modalreturn')
@include('geren.orden_trabajo.modaldelete')
@endsection