...
@include('geren.unidad_medida.modaladd')
@include('geren.unidad_medida.modaledit')
@include('geren.unidad_medida.modaldelete')
@include('geren.unidad_medida.modalerror')
