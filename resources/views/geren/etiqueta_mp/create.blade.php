		...
		$.post(url, data,
			function(data){
				...
				{	
					...
					var printPage = window.open('{{ url("geren/etiqueta_mp/print") }}'+'/'+data['etiqueta_mp_id'], '');
					//printPage.close();
...
<div class="row" id="modal_create">
	<div class="col-md-12">
	    <div class="box box-primary">
	        ...
	        <div class="box-body">
	        	{!! Form::open(['url' => 'geren/etiqueta_mp/store',
                  'method' => 'POST',
                  'id' => 'form-add']) !!}

	        	@include('geren.etiqueta_mp.fields')
...
@include('geren.etiqueta_mp.modallotes')
