        ...
        <div class="col-md-11">
            <div class="box box-primary">
                <div class="box-body">
                    ...
                    <a class="btn btn-primary" href="{{ url('geren/despacho/despachados') }}" id="despachados">
                        Despachados
                    </a>
                    <br><br>
...
@include('geren.despacho.modaladd')
@include('geren.despacho.modalorden')
@include('geren.despacho.modaledit')
