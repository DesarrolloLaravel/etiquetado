...
@include('almacenamiento.user.modaladd')
@include('almacenamiento.user.modaledit')
@include('almacenamiento.user.modaldelete')
@include('almacenamiento.user.modalerror')
