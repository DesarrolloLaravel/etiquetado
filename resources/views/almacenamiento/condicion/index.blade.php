...
@include('almacenamiento.condicion.modaladd')
@include('almacenamiento.condicion.modaledit')
@include('almacenamiento.condicion.modaldelete')
@include('almacenamiento.condicion.modalerror')
