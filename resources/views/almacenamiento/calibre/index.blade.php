...
@include('almacenamiento.calibre.modaladd')
@include('almacenamiento.calibre.modaledit')
@include('almacenamiento.calibre.modaldelete')
@include('almacenamiento.calibre.modalerror')
@endsection