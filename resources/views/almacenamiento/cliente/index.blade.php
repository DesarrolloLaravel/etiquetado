...
@include('almacenamiento.cliente.modaladd')
@include('almacenamiento.cliente.modaledit')
@include('almacenamiento.cliente.modaldelete')
@include('almacenamiento.cliente.modalerror')
