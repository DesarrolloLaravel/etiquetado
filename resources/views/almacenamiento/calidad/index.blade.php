...
@include('almacenamiento.calidad.modaladd')
@include('almacenamiento.calidad.modaledit')
@include('almacenamiento.calidad.modaldelete')
@include('almacenamiento.calidad.modalerror')
