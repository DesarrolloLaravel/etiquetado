            ...
            $.get('etiqueta/reprint',
                ...
                function(data){
                    if(data[0] == "ok")
                    {
                        ...
                        var printPage = window.open('{{ url("almacenamiento/etiqueta/print") }}'+'/'+etiqueta_id+'/'+idioma, '');
                        printPage.print();
                    }
                    else
                    {
...
@include('almacenamiento.etiqueta.modalrecepcion')
@include('almacenamiento.etiqueta.modalcancel')
@include('almacenamiento.etiqueta.modalidioma')
