...
@include('almacenamiento.especie.modaladd')
@include('almacenamiento.especie.modaledit')
@include('almacenamiento.especie.modaldelete')
@include('almacenamiento.especie.modalerror')
