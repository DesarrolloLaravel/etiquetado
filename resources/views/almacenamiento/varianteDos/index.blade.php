...
@include('almacenamiento.varianteDos.modaladd')
@include('almacenamiento.varianteDos.modaledit')
@include('almacenamiento.varianteDos.modaldelete')
@include('almacenamiento.varianteDos.modalerror')
