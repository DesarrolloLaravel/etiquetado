...
@include('almacenamiento.productor.modaladd')
@include('almacenamiento.productor.modaledit')
@include('almacenamiento.productor.modaldelete')
@include('almacenamiento.productor.modalerror')
