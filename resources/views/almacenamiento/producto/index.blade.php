...
@include('almacenamiento.producto.modaladd')
@include('almacenamiento.producto.modaledit')
@include('almacenamiento.producto.modaldelete')
@include('almacenamiento.producto.modalerror')
