...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $('#table-trim tbody').on( 'click', '#edit', function ()
        {
            $(".alert").hide();

            trim_id = $(this).parents('tr').data('id');
        ...
        $('#table-trim tbody').on( 'click', '#delete', function ()
        {
            $(".alert").hide();
        ...
        $("#save").click(function(){
            ...
            $.post(url, data, function(resp)
            {
                if(resp[0] == "ok")
                {
                    ...
                    $(".alert-success").hide();
                    $(".alert-danger").html("Ya existe una variante con ese nombre, revise su información").show();    
                }
    ...
    function setValues(data, n)
    {
        ...
        $("#"+form+" input[name='trim_id']").val(data.trim_id);
        $("#"+form+" input[name='trim_name']").val(data.trim_name);
        ...
        <div class="col-md-11">
            <div class="box box-primary">
                <div class="box-body">
                    ...
                    <table class="table table-bordered" id="table-trim" width="100%">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>Trim</th>
                        ...
                        <tbody>
                            ...
                            <tr role="row" data-id="{{ $trim->trim_id }}">
                                <td>{{ $trim->trim_id }}</td>
...
@include('almacenamiento.trim.modaladd')
@include('almacenamiento.trim.modaledit')
@include('almacenamiento.trim.modaldelete')
@include('almacenamiento.trim.modalerror')
