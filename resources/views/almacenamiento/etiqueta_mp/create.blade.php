		...
		$.post(url, data,
			function(data){
				...
				{	
					...
					var printPage = window.open('{{ url("almacenamiento/etiqueta_mp/print") }}'+'/'+data['etiqueta_mp_id'], '');
					//printPage.close();
...
<div class="row" id="modal_create">
	<div class="col-md-12">
	    <div class="box box-primary">
	        ...
	        <div class="box-body">
	        	{!! Form::open(['url' => 'almacenamiento/etiqueta_mp/store',
                  'method' => 'POST',
                  'id' => 'form-add']) !!}

	        	@include('almacenamiento.etiqueta_mp.fields')
...
@include('almacenamiento.etiqueta_mp.modallotes')
