        ...
        <div class="col-md-12">
            <div class="box box-primary">
                <div class="box-body">
                    ...
                    <a class="btn btn-primary" href="{{ url('/almacenamiento/anulados') }}" id="anulados">
                        Anulados
                    </a>
                    <br><br>
...
@include('almacenamiento.lote.produccion')
@include('almacenamiento.lote.modaledit')
@include('almacenamiento.lote.modaldelete')
