...
@include('almacenamiento.variante.modaladd')
@include('almacenamiento.variante.modaledit')
@include('almacenamiento.variante.modaldelete')
@include('almacenamiento.variante.modalerror')
