...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $('#table-envases tbody').on( 'click', '#edit', function ()
        {
            $(".alert").hide();

            envase_id = $(this).parents('tr').data('id');
        ...
        $('#table-envases tbody').on( 'click', '#delete', function ()
        {
            $(".alert").hide();
    ...
    function setValues(data, n)
    {
        ...
        $("#"+form+" input[name='envase_id']").val(data.envase_id);
        $("#"+form+" input[name='envase_nombre']").val(data.envase_nombre);
        $("#"+form+" input[name='envase_capacidad']").val(data.envase_capacidad);
        ...
        <div class="col-md-11">
            <div class="box box-primary">
                <div class="box-body">
                    ...
                    <table class="table table-bordered" id="table-envases" width="100%">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>Envase</th>
                        ...
                        <tbody>
                            ...
                            <tr role="row" data-id="{{ $envase->envase_id }}">
                                <td>{{ $envase->envase_id }}</td>
                                <td>{{ $envase->envase_nombre }}</td>
                                <td>{{ $envase->envase_capacidad }}</td>
                                <td></td>
                            </tr>
                            @endforeach
                        </tbody>
...
@include('almacenamiento.envase.modaladd')
@include('almacenamiento.envase.modaledit')
@include('almacenamiento.envase.modaldelete')
@include('almacenamiento.envase.modalerror')
