        ...
        <div class="col-md-11">
            <div class="box box-primary">
                <div class="box-body">
                    ...
                    <a class="btn btn-primary" href="{{ url('almacenamiento/despacho/despachados') }}" id="despachados">
                        Despachados
                    </a>
                    <br><br>
...
@include('almacenamiento.despacho.modaladd')
@include('almacenamiento.despacho.modalorden')
@include('almacenamiento.despacho.modaledit')
@include('almacenamiento.despacho.modaldelete')
