        ...
        $.post(url, data,
            function(data){
                if(data['estado'] == "ok")
                {
                    ...
                    var printPage = window.open('{{ url("almacenamiento/etiqueta/print_especial") }}'+'/'+data['etiqueta_id']+'/'+$("#idioma").val(), '');
                    //printPage.close();
    ...
    <div class="col-md-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">Ingreso de datos - Especifica</h3>
                <br>
            ...
            <div class="box-body">
                {!! Form::open(['url' => 'almacenamiento/etiqueta/store',
                  'method' => 'POST',
                  'id' => 'form-add']) !!}

                @include('almacenamiento.etiqueta.fields')
...
@include('almacenamiento.etiqueta.modallotes')
@include('almacenamiento.etiqueta.modalordentrabajo')
