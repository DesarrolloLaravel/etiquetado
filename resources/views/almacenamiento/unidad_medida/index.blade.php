...
@include('almacenamiento.unidad_medida.modaladd')
@include('almacenamiento.unidad_medida.modaledit')
@include('almacenamiento.unidad_medida.modaldelete')
@include('almacenamiento.unidad_medida.modalerror')
