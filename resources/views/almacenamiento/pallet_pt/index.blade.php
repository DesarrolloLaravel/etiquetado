            ...
            $.get('etiqueta/reprint',
                ...
                function(data){
                    if(data[0] == "ok")
                    {
                        ...
                        var printPage = window.open('{{ url("almacenamiento/etiqueta_mp/print") }}'+'/'+etiqueta__id+'/'+idioma, '');
                        printPage.print();
                    }
                    else
                    {
...
@include('almacenamiento.etiqueta_mp.modalrecepcion')
@include('almacenamiento.etiqueta_mp.modalcancel')
