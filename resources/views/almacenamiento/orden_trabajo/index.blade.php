...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        {   
            ...
            var printPage = window.open('{{ url("almacenamiento/etiqueta_mp/print") }}'+'/'+etiqueta_id, '');
            alert(printPage);
        });
...
@include('almacenamiento.orden_trabajo.modaladd')
@include('almacenamiento.orden_trabajo.modaledit')
@include('almacenamiento.orden_trabajo.modalreturn')
@include('almacenamiento.orden_trabajo.modaldelete')
@include('almacenamiento.orden_trabajo.modalreturnetiqueta')
@endsection